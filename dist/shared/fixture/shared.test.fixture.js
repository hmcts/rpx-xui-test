...
exports.aCaseField = function (id, label, type, display_context, show_summary_content_option, typeComplexFields) {
...
exports.createCaseField = function (id, label, hint, fieldType, display_context, order, show_condition, ACLs) {
