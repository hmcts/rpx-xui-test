...
(function (PlaceholderService) {
    var PlaceholderSubstitutor = /** @class */ (function () {
        ...
        PlaceholderSubstitutor.prototype.getNewNumberOfCollectionItemsIfHigher = function (newNumberOfCollectionItemsAsPlaceholder, numberCollectionItemsAsPlaceholder) {
        ...
        PlaceholderSubstitutor.prototype.updateNumberOfCollectionItemsAsPlaceholder = function () {
            if (this.fieldIdToSubstitute.split('.').length > 1) {
                var newNumberOfCollectionItemsAsPlaceholder = this.getNumberOfCollectionItemsIfAny();
                this.numberCollectionItemsAsPlaceholder =
                    this.getNewNumberOfCollectionItemsIfHigher(newNumberOfCollectionItemsAsPlaceholder, this.numberCollectionItemsAsPlaceholder);
            }
        };
        PlaceholderSubstitutor.prototype.substituteFromFormFields = function () {
            var replacedString = this.stringToResolve.substring(this.startSubstitutionIndex)
