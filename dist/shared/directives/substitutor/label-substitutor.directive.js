...
var LabelSubstitutorDirective = /** @class */ (function () {
    ...
    LabelSubstitutorDirective.prototype.removeDuplicates = function (arr) {
        var unique_array = [];
        arr.forEach(function (caseField) {
            if (unique_array.filter(function (e) { return e['id'] === caseField.id; }).length === 0) {
    ...
    LabelSubstitutorDirective = __decorate([
         ...
         */
        ,
        __metadata("design:paramtypes", [fields_utils_1.FieldsUtils, services_1.PlaceholderService])
