...
var CasesService = /** @class */ (function () {
    function CasesService(http, appConfig, orderService, errorService, wizardPageFieldToCaseFieldMapper, workAllocationService, loadingService) {
        this.http = http;
    ...
    CasesService.prototype.setDynamicListDefinition = function (caseField, caseFieldType, rootCaseField) {
        ...
        if (caseFieldType.type === CasesService_1.SERVER_RESPONSE_FIELD_TYPE_COMPLEX) {
            caseFieldType.complex_fields.forEach(function (field) {
                try {
                    if (field.field_type.type === CasesService_1.SERVER_RESPONSE_FIELD_TYPE_DYNAMIC_LIST) {
    ...
    CasesService.SERVER_RESPONSE_FIELD_TYPE_DYNAMIC_LIST = 'DynamicList';
