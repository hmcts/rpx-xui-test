...
import { CaseEventData, CaseEventTrigger, CasePrintDocument, CaseView } from '../../../domain';
...
export declare class CasesService {
    ...
    static readonly SERVER_RESPONSE_FIELD_TYPE_DYNAMIC_LIST = "DynamicList";
    /**
     *
    ...
    constructor(http: HttpService, appConfig: AbstractAppConfig, orderService: OrderService, errorService: HttpErrorService, wizardPageFieldToCaseFieldMapper: WizardPageFieldToCaseFieldMapper, workAllocationService: WorkAllocationService, loadingService: LoadingService);
