...
var ReadComplexFieldComponent = /** @class */ (function (_super) {
    ...
    ReadComplexFieldComponent_1 = ReadComplexFieldComponent;
    ReadComplexFieldComponent.prototype.ngOnInit = function () {
        ...
        if (this.caseField.field_type) {
            this.caseField.field_type.complex_fields.map(function (field) {
                if (field.field_type.type === ReadComplexFieldComponent_1.FIELD_TYPE_DYNAMIC_LIST) {
    ...
    var ReadComplexFieldComponent_1;
    ReadComplexFieldComponent.FIELD_TYPE_DYNAMIC_LIST = 'DynamicList';
    __decorate([
        core_1.Input(),
        __metadata("design:type", Array)
    ], ReadComplexFieldComponent.prototype, "caseFields", void 0);
    ReadComplexFieldComponent = ReadComplexFieldComponent_1 = __decorate([
        core_1.Component({
