...
var collection_create_checker_service_1 = require("./collection-create-checker.service");
var WriteCollectionFieldComponent = /** @class */ (function (_super) {
    __extends(WriteCollectionFieldComponent, _super);
    function WriteCollectionFieldComponent(dialog, scrollToService, profileNotifier, createChecker) {
        var _this = _super.call(this) || this;
        _this.dialog = dialog;
        _this.scrollToService = scrollToService;
        _this.profileNotifier = profileNotifier;
        _this.createChecker = createChecker;
        _this.caseFields = [];
        _this.collItems = [];
        return _this;
    }
    ...
    WriteCollectionFieldComponent.prototype.buildCaseField = function (item, index) {
        ...
        var cf = this.newCaseField(cfid, item);
    ...
    WriteCollectionFieldComponent.prototype.newCaseField = function (id, item) {
        var isNotAuthorisedToUpdate = this.isNotAuthorisedToUpdate();
    ...
    WriteCollectionFieldComponent.prototype.addItem = function (doScroll) {
        ...
        var caseField = this.buildCaseField(item, index);
    ...
    WriteCollectionFieldComponent.prototype.isNotAuthorisedToUpdate = function () {
        var _this = this;
        if (this.isExpanded) {
            return false;
        }
